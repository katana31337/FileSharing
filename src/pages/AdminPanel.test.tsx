...
vi.mock('../services/adminService', () => ({
  ...
  getAdminSettingsAsync: vi.fn(() => Promise.resolve({
    maxFileSize: 100 * 1024 * 1024,
    minExpirationDays: 1,
    maxExpirationDays: 30,
    defaultExpirationDays: 7,
  ...
  saveAdminSettingsAsync: vi.fn((settings) => Promise.resolve(settings)),
  resetAdminSettings: vi.fn(),
  resetAdminSettingsAsync: vi.fn(() => Promise.resolve({
    maxFileSize: 100 * 1024 * 1024,
    minExpirationDays: 1,
    maxExpirationDays: 30,
    defaultExpirationDays: 7,
