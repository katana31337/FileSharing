...
Проект покрыт тестами с использованием Vitest и React Testing Library.
...
GitHub Actions запускает тесты на Node.js 18.x и 20.x, что гарантирует совместимость с разными версиями Node.
...
- ✅ Утилиты (генерация ссылок, ID)
- ✅ Сервисы (админка, хранение)
- ✅ Компоненты (Toast, FileUpload)
