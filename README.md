...
- [🚀 Быстрый старт по сценариям](QUICKSTART.md)
- [📖 Подробная инструкция по установке](INSTALL.md)
- [🔄 Обновление после изменений](UPDATE.md)
...
- [🔑 Создание учётных данных администратора](ADMIN_CREDENTIALS.md)
- [⚡ Быстрое создание учётных данных](QUICK_ADMIN_CREDENTIALS.md)
- [📦 Хранение файлов в /dataStore](STORAGE.md)
- [🔔 Обработка ошибок](ERROR_HANDLING.md)
- [⚡ Быстрая обработка ошибок](QUICK_ERRORS.md)
- [📜 Скрипты управления](SCRIPTS.md)
...
- ✅ Создаст SQL миграции прямо в директории установки
...
**Учётные данные администратора** создаются при первом входе в админ-панель через веб-интерфейс.
...
> 💡 **Примечание:** Скрипты диагностики работают из любой директории проекта. Если вы делаете `git pull` в свою папку и запускаете оттуда — скрипты автоматически определят текущую директорию.

### Запуск для разработки

Если вы хотите запустить проект локально для разработки, следуйте инструкциям в [DEVELOPMENT.md](./DEVELOPMENT.md).

**Краткая инструкция:**

1. Запустите PostgreSQL (через Docker или локально)
2. Запустите Backend: `cd server && npm install && npm run dev`
3. Запустите Frontend: `npm install && npm run dev`
4. Откройте `http://localhost:3000`

Теперь файлы будут храниться на сервере и доступны из любого браузера!
...
- [x] ~~Хранение настроек админки в PostgreSQL~~ ✅ Реализовано
