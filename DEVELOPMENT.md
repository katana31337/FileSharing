...
> 💡 **Примечание:** Если вы делаете `git pull` в свою папку и запускаете оттуда — скрипты автоматически определят текущую директорию. Не нужно вручную переходить в `/opt/fileshare`.
