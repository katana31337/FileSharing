...
Админ-панель доступна по адресу `/#/admin` (иконка шестерёнки в шапке сайта).
...
| **Пароль администратора** | Пароль для входа в админку | admin123 |

### ⚠️ Важно:

- **Смените пароль по умолчанию** сразу после первого входа!
