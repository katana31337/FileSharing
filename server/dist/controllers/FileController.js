...
export class FileController {
    ...
    upload = async (req, res) => {
        try {
            ...
            const item = await this.fileService.uploadFile(fileStream, file.originalname, file.size, file.mimetype, days, maxDownloads ? parseInt(maxDownloads) : undefined, password || undefined);
